...
namespace SprykerShop\Yves\ShoppingListPage\Dependency\Service;

use Generated\Shared\Transfer\NumberFormatConfigTransfer;

class ShoppingListPageToUtilNumberServiceBridge implements ShoppingListPageToUtilNumberServiceInterface
{
    /**
